...
contains
  ...
  subroutine Compute_E_S_G_Kernel &
               ( E, S_1, S_2, S_3, J, H_1, H_2, H_3, FF, SF, &
                 M_DD_22, M_DD_33, V_1, V_2, V_3 )

    !-- Compute_Conserved_Energy_Momentum_Galilean_Kernel
  ...
  subroutine Compute_J_H_G_Kernel &
               ( J, H_1, H_2, H_3, E, S_1, S_2, S_3, FF, SF, RM, &
                 M_DD_22, M_DD_33, M_UU_22, M_UU_33, V_1, V_2, V_3 )

    !-- Compute_Comoving_Energy_Momentum_Galilean_Kernel
  ...
  subroutine Compute_FE_G_Kernel &
               ( FEP_1, FEP_2, FEP_3, FEM_1, FEM_2, FEM_3, &
                 J, H_1, H_2, H_3, M_UU_22, M_UU_33, c )

    !-- Compute_FastEigenspeeds_Galilean_Kernel
  ...
  end subroutine Compute_FE_G_Kernel
  ...
  subroutine ComputeRawFluxes_G_Kernel &
    ...
    !-- ComputeRawFluxes_Galilean_Kernel
