module DivergencePart_NM_G__Form

  !-- DivergencePart_NeutrinoMoments_Grey__Form
  ...
  type, public, extends ( DivergencePart_RM_Form ) :: DivergencePart_NM_G_Form
  contains
    ...
    final :: &
      Finalize
  end type DivergencePart_NM_G_Form
...
contains
  ...
  subroutine Initialize ( DP, CS, NameOption, IgnorabilityOption )
    ...
    class ( DivergencePart_NM_G_Form ), intent ( inout ) :: &
      DP
  ...
  subroutine ComputeFluxes ( FS_F, DP, FS_CS, iC, iD )
    ...
    class ( FieldSet_BM_Form ), intent ( inout ) :: &
      FS_F  !-- Fluxes
    class ( DivergencePart_NM_G_Form ), intent ( in ) :: &
      DP
    ...
    call Search &
           ( CS % iaBalanced, CS % NUMBER_DENSITY_B, iNumber )
    ...
    class default
      ...
      call Show ( 'DivergencePart_NM_G__Form', 'module', CONSOLE % ERROR )
  ...
  impure elemental subroutine Finalize ( DP )
    ...
    type ( DivergencePart_NM_G_Form ), intent ( inout ) :: &
      DP

  end subroutine Finalize


end module DivergencePart_NM_G__Form
