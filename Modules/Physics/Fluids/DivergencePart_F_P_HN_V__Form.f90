module DivergencePart_F_P_HN_V__Form

  !-- DivergencePart_Fluid_Perfect_HeavyNucleus_Velocity__Form
  ...
  contains
    ...
    final :: &
      Finalize
  end type DivergencePart_F_P_HN_V_Form
...
contains
  ...
  subroutine Initialize ( DP, CS, NameOption, IgnorabilityOption )
    ...
    class ( DivergencePart_F_P_HN_V_Form ), intent ( inout ) :: &
      DP
    ...
    if ( DP % Type  ==  '' ) &
      DP % Type  =  'a DivergencePart_F_P_HN_V' 
  ...
  impure elemental subroutine Finalize ( DP )
    ...
    type ( DivergencePart_F_P_HN_V_Form ), intent ( inout ) :: &
      DP

  end subroutine Finalize


end module DivergencePart_F_P_HN_V__Form
