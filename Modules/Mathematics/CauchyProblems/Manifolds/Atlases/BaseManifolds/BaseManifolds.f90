module BaseManifolds
  ...
  use Atlas_SCG_SC__Form  !-- Atlas_SingleChartGrid_SymmetricCurvilinear_Form
  use Atlas_SCG_C__Form   !-- Atlas_SingleChartGrid_Central_Form
  use Atlas_SCG_CE__Form  !-- Atlas_SingleChartGrid_CentralExcision_Form
  use Atlas_SCG_CC__Form  !-- Atlas_SingleChartGrid_CentralCore_Form
