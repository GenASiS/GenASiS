...
submodule ( Integrator_CSA__Form ) Integrator_CSA__Kernel
...
contains
  ...
  module procedure Compute_dT_CSC_Kernel
  ...
  end procedure Compute_dT_CSC_Kernel

  
end submodule Integrator_CSA__Kernel
