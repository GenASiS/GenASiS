module OnDevice_Function
  ...
  interface OnDevice
    ...
    module procedure OnDevice_2D
    module procedure OnDevice_3D
    module procedure OnDevice_4D
...
contains
  ...
  function OnDevice_2D ( Value ) result ( IP )
  ...
  function OnDevice_4D ( Value ) result ( IP )
