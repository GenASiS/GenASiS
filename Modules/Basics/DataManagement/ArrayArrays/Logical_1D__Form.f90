!-- Logical_1D_Form allows the construction of an array of 1D integer
!   arrays to form ragged arrays.

module Logical_1D__Form
...
contains
  ...
  subroutine Initialize_I_1D ( A, nValues, ClearOption, iLowerBoundOption )
    ...
    class ( Logical_1D_Form ), intent ( inout ) :: &
      A
  ...
  subroutine Initialize_I_1D_Copy ( A, B, iLowerBoundOption )
    ...
    class ( Logical_1D_Form ), intent ( inout ) :: &
      A
    type (  Logical_1D_Form ), intent ( in ) :: &
      B
    integer ( KDI ), intent ( in ), optional :: &
      iLowerBoundOption
  ...
  impure elemental subroutine Finalize_I_1D ( A )
    ...
    type ( Logical_1D_Form ), intent ( inout ) :: &
      A
