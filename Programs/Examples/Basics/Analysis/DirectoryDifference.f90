program DirectoryDifference
  ...
  !-- Calculate the L1 error between two OutputDirectory
  ...
  OutputDirectory_1 = '../Output/'
  call PH % GetParameter ( OutputDirectory_1, 'OutputDirectory_1' )
  
  OutputDirectory_2 = '../Output/'
  call PH % GetParameter ( OutputDirectory_2, 'OutputDirectory_2' )
  ...
  deallocate ( GIS ) !-- Trigger finalization
  
  allocate ( GIS )
  call GIS % Initialize &
        ( Filename, PH % Communicator, &
          WorkingDirectoryOption = OutputDirectory_2 )
