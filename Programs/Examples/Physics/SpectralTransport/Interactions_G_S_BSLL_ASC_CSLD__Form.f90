module Interactions_G_S_BSLL_ASC_CSLD__Form
  ...
  use Interactions_G_S_ASC__Form

  implicit none
  private

  type, public, extends ( Interactions_BSLL_ASC_CSLD_Template ) :: &
    Interactions_G_S_BSLL_ASC_CSLD_Form
  contains
    procedure, public, pass :: &
      Initialize
    procedure, public, pass :: &
      Set => Set_G_S_BSLL_ASC_CSLD
    procedure, public, pass :: &
      AllocateField
  end type Interactions_G_S_BSLL_ASC_CSLD_Form
...
contains
  ...
  subroutine Initialize &
    ...
    if ( IB % Type == '' ) &
      IB % Type = 'an Interactions_G_S_BSLL_ASC_CSLD'
  ...
  end subroutine Set_G_S_BSLL_ASC_CSLD
  ...
  subroutine AllocateField ( IB, iF )
    ...
    allocate ( Interactions_G_S_ASC_Form :: &
                 IB % Fiber % Atlas ( iF ) % Element )

  end subroutine AllocateField


end module Interactions_G_S_BSLL_ASC_CSLD__Form
