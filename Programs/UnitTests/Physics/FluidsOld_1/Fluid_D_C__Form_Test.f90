program Fluid_D_C__Form_Test

  !-- Fluid_Dust_Chart_Form_Test
  ...
  type ( Units_F_Form ), allocatable :: &
    U
  type ( Fluid_D_C_Form ), allocatable :: &
    FC

  allocate ( PROGRAM_HEADER )
  call PROGRAM_HEADER % Initialize &
         ( 'Fluid_D_C__Form_Test', DimensionalityOption = '2D' )
...
end program Fluid_D_C__Form_Test
