program Eigenspeeds_F_C__Form_Test

  !-- Eigenspeeds_Fast_Chart__Form_Test
  ...
  call PROGRAM_HEADER % Initialize &
         ( 'Eigenspeeds_F_C__Form_Test', DimensionalityOption = '2D' )
...
end program Eigenspeeds_F_C__Form_Test
