program Geometry_F_ASG__Form_Test

  !-- Geometry_F_AtlasSingleGrid__Form_Test
  ...
  call PROGRAM_HEADER % Initialize &
         ( 'Geometry_F_ASG__Form_Test', DimensionalityOption = '2D' )
...
end program Geometry_F_ASG__Form_Test
