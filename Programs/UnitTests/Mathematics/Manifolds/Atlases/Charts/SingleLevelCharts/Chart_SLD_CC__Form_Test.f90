module Chart_SLD_CC__Form_Test__Form
  ...
  character ( LDF ), public, parameter :: &
    ProgramName = 'Chart_SLD_CC__Form_Test'

  type, public :: Chart_SLD_CC__Form_Test_Form
    ...
    type ( GeometryFlat_CSL_Form ), allocatable :: &
      Geometry
    type ( Chart_SLD_CC_Form ), allocatable :: &
      Chart
  contains
    ...
    final :: &
      Finalize
  end type Chart_SLD_CC__Form_Test_Form
...
end module Chart_SLD_CC__Form_Test__Form



program Chart_SLD_CC__Form_Test

  use Basics
  use Chart_SLD_CC__Form_Test__Form
  
  implicit none

  type ( Chart_SLD_CC__Form_Test_Form ), allocatable :: &
    CFT
...
end program Chart_SLD_CC__Form_Test
